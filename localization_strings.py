...
EN_US = {
    ...
    "loc_user_settings_2": "Settings will be applied to any new voting session created by you in any Space. If you want to change the voting settings later, visit this form and change the settings before the voting session start.",
